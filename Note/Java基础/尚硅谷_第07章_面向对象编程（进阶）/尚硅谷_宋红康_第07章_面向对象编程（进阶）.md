...
<img src="https://raw.githubusercontent.com/pvisanhash/PicSiteRepo1/main/note/img/202309011319317.png" alt="第2阶段：Java面向对象编程-第07章" style="zoom: 67%;" />
...
<img src="https://raw.githubusercontent.com/pvisanhash/PicSiteRepo1/main/note/img/202309011319318.png" alt="image-20220503102947013" style="zoom:67%;" />
...
![image-20220808191154534](https://raw.githubusercontent.com/pvisanhash/PicSiteRepo1/main/note/img/202309011319299.png)

**练习2：**

（1）按照如下的UML类图，创建相应的类，提供必要的结构：

<img src="https://raw.githubusercontent.com/pvisanhash/PicSiteRepo1/main/note/img/202309011319319.png" alt="image-20220323211412409" style="zoom:50%;" />

在提款方法withdraw()中，需要判断用户余额是否能够满足提款数额的要求，如果不能，应给出提示。deposit()方法表示存款。

（2）按照如下的UML类图，创建相应的类，提供必要的结构

<img src="https://raw.githubusercontent.com/pvisanhash/PicSiteRepo1/main/note/img/202309011319320.png" alt="image-20220323211454372" style="zoom:50%;" />

（3）按照如下的UML类图，创建相应的类，提供必要的结构

<img src="https://raw.githubusercontent.com/pvisanhash/PicSiteRepo1/main/note/img/202309011319321.png" alt="image-20220323211521808" style="zoom:50%;" />
...
<img src="https://raw.githubusercontent.com/pvisanhash/PicSiteRepo1/main/note/img/202309011319322.png" alt="image-20220323211653907" style="zoom:80%;" />
...
<img src="https://raw.githubusercontent.com/pvisanhash/PicSiteRepo1/main/note/img/202309011319323.png" alt="image-20220323215921441" style="zoom: 50%;" />

- 绿化：前人栽树，后人乘凉

<img src="https://raw.githubusercontent.com/pvisanhash/PicSiteRepo1/main/note/img/202309011319324.png" alt="image-20220520171727778" style="zoom: 50%;" />

“绿水青山，就是金山银山”

* 样貌：

  <img src="https://raw.githubusercontent.com/pvisanhash/PicSiteRepo1/main/note/img/202309011319325.png" alt="image-20220323220246746" style="zoom: 50%;" />

* 继承之外，是不是还可以"`进化`"：

  <img src="https://raw.githubusercontent.com/pvisanhash/PicSiteRepo1/main/note/img/202309011319326.png" alt="image-20220323220537644" style="zoom: 50%;" />
...
为描述和处理**个人**信息，定义类Person：
 ...
 <img src="https://raw.githubusercontent.com/pvisanhash/PicSiteRepo1/main/note/img/202309011319327.png" alt="image-20220323220923386" style="zoom:67%;" />

为描述和处理**学生**信息，定义类Student：

 <img src="https://raw.githubusercontent.com/pvisanhash/PicSiteRepo1/main/note/img/202309011319328.png" alt="image-20220323221001495" style="zoom:67%;" />

通过继承，简化Student类的定义：

 <img src="https://raw.githubusercontent.com/pvisanhash/PicSiteRepo1/main/note/img/202309011319329.png" alt="image-20220323221050791" style="zoom:67%;" />

> 说明：Student类继承了父类Person的所有属性和方法，并增加了一个属性school。Person中的属性和方法，Student都可以使用。

**角度二：从下而上**

![](https://raw.githubusercontent.com/pvisanhash/PicSiteRepo1/main/note/img/202309011319300.jpg)

多个类中存在相同属性和行为时，将这些内容抽取到单独一个类中，那么多个类中无需再定义这些属性和行为，只需要和抽取出来的类构成`继承关系`。如图所示：

<img src="https://raw.githubusercontent.com/pvisanhash/PicSiteRepo1/main/note/img/202309011319330.jpg" style="zoom: 67%;" />

再举例：

<img src="https://raw.githubusercontent.com/pvisanhash/PicSiteRepo1/main/note/img/202309011319331.png" alt="image-20220323221436571" style="zoom:67%;" />
...
![image-20211230090255997](https://raw.githubusercontent.com/pvisanhash/PicSiteRepo1/main/note/img/202309011319301.png)

**2、子类不能直接访问父类中私有的(private)的成员变量和方法**

子类虽会继承父类私有(private)的成员变量，但子类不能对继承的私有成员变量直接进行访问，可通过继承的get/set方法进行访问。如图所示：

![image-20220323224757212](https://raw.githubusercontent.com/pvisanhash/PicSiteRepo1/main/note/img/202309011319302.png)
...
<img src="https://raw.githubusercontent.com/pvisanhash/PicSiteRepo1/main/note/img/202309011319332.png" alt="image-20220323225441417" style="zoom:67%;" />
...
<img src="https://raw.githubusercontent.com/pvisanhash/PicSiteRepo1/main/note/img/202309011319333.png" alt="image-20220514162507692" style="zoom:67%;" />

<img src="https://raw.githubusercontent.com/pvisanhash/PicSiteRepo1/main/note/img/202309011319334.png" alt="image-20220523201405061" style="zoom:67%;" />
...
<img src="https://raw.githubusercontent.com/pvisanhash/PicSiteRepo1/main/note/img/202309011319335.png" alt="image-20220323231804928" style="zoom:67%;" />
...
<img src="https://raw.githubusercontent.com/pvisanhash/PicSiteRepo1/main/note/img/202309011319336.png" alt="image-20220323231942361" style="zoom:67%;" />
...
![image-20211230093627763](https://raw.githubusercontent.com/pvisanhash/PicSiteRepo1/main/note/img/202309011319303.png)

（2）外部类的权限修饰符如果缺省，跨包使用有问题

![image-20211230094236974](https://raw.githubusercontent.com/pvisanhash/PicSiteRepo1/main/note/img/202309011319304.png)

**2、成员的权限修饰符问题**

（1）本包下使用：成员的权限修饰符可以是public、protected、缺省

![image-20211230095320646](https://raw.githubusercontent.com/pvisanhash/PicSiteRepo1/main/note/img/202309011319305.png)

（2）跨包下使用：要求严格

![image-20211230095817784](https://raw.githubusercontent.com/pvisanhash/PicSiteRepo1/main/note/img/202309011319306.png)

（3）跨包使用时，如果类的权限修饰符缺省，成员权限修饰符>类的权限修饰符也没有意义

![image-20211230100219840](https://raw.githubusercontent.com/pvisanhash/PicSiteRepo1/main/note/img/202309011319307.png)
...
![image-20211230110411580](https://raw.githubusercontent.com/pvisanhash/PicSiteRepo1/main/note/img/202309011319308.png)
...
![image-20200227141228450](https://raw.githubusercontent.com/pvisanhash/PicSiteRepo1/main/note/img/202309011319309.png)
...
![image-20200303183542807](https://raw.githubusercontent.com/pvisanhash/PicSiteRepo1/main/note/img/202309011319310.png)
...
![image-20220324003430464](https://raw.githubusercontent.com/pvisanhash/PicSiteRepo1/main/note/img/202309011319311.png)
...
![image-20220324003447242](https://raw.githubusercontent.com/pvisanhash/PicSiteRepo1/main/note/img/202309011319312.png)
...
![image-20220324003616767](https://raw.githubusercontent.com/pvisanhash/PicSiteRepo1/main/note/img/202309011319313.png)

## 6. 子类对象实例化全过程

![image-20220324003713230](https://raw.githubusercontent.com/pvisanhash/PicSiteRepo1/main/note/img/202309011319314.png)

```java
Dog dog = new Dog("小花","小红");
```

<img src="https://raw.githubusercontent.com/pvisanhash/PicSiteRepo1/main/note/img/202309011319337.png" alt="image-20220324003735416" style="zoom:80%;" />

<img src="https://raw.githubusercontent.com/pvisanhash/PicSiteRepo1/main/note/img/202309011319338.png" alt="image-20220324003813163" style="zoom:67%;" />
...
![image-20220324234208997](https://raw.githubusercontent.com/pvisanhash/PicSiteRepo1/main/note/img/202309011319315.png)

前提：Person类中定义了welcome()方法，各个子类重写了welcome()。

![image-20220324234214932](https://raw.githubusercontent.com/pvisanhash/PicSiteRepo1/main/note/img/202309011319316.png)
...
<img src="https://raw.githubusercontent.com/pvisanhash/PicSiteRepo1/main/note/img/202309011319339.png" alt="image-20220324235337563" style="zoom:80%;" />
...
<img src="https://raw.githubusercontent.com/pvisanhash/PicSiteRepo1/main/note/img/202309011319340.png" alt="image-20220325000034619" style="zoom:67%;" />
...
<img src="https://raw.githubusercontent.com/pvisanhash/PicSiteRepo1/main/note/img/202309011319341.png" alt="image-20220503104750655" style="zoom:67%;" />
...
- 只能比较引用类型，Object类源码中equals()的作用与“==”相同：比较是否指向同一个对象。	 
  ...
  <img src="https://raw.githubusercontent.com/pvisanhash/PicSiteRepo1/main/note/img/202309011319342.png" alt="image-20220503104750655" style="zoom:67%;" />
...
<img src="https://raw.githubusercontent.com/pvisanhash/PicSiteRepo1/main/note/img/202309011319343.png" alt="image-20220325002959156" style="zoom:67%;" />

<img src="https://raw.githubusercontent.com/pvisanhash/PicSiteRepo1/main/note/img/202309011319344.png" alt="image-20220325002932102" style="zoom:67%;" />
